...
namespace ChessConsole.Pieces
{
    ...
    {
        /// <rezumat>
        /// Posibile locuri în care cavalerul poate sări
        /// </rezumat>
        ...
        {
            //Loviturile cavalerului nu pot fi blocate
            for (int i = 0; i < 8; i++)
        ...
        public override char Char => 'H'; //H pentru cal, deoarece folosim K pentru rege
    }
}